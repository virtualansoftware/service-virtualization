    ...
    implements Equals, HashCode, ToString
{
    ...
    protected List<DescribeNounResult> results;
     ...
     * 
     */
    public List<DescribeNounResult> getResults() {
        if (results == null) {
            results = new ArrayList<DescribeNounResult>();
        }
        return this.results;
    }

    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof DescribeNounsResponse)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final DescribeNounsResponse that = ((DescribeNounsResponse) object);
        {
            List<DescribeNounResult> lhsResults;
            lhsResults = (((this.results!= null)&&(!this.results.isEmpty()))?this.getResults():null);
            List<DescribeNounResult> rhsResults;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            List<DescribeNounResult> theResults;
