 ...
 *       &lt;sequence&gt;
 *         &lt;element name="result" type="{urn:partner.soap.sforce.com}FindDuplicatesResult" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "findDuplicatesByIdsResponse")
public class FindDuplicatesByIdsResponse
    implements Equals, HashCode, ToString
{

    @XmlElement(name = "result")
    protected List<FindDuplicatesResult> results;
     ...
     * 
     */
    public List<FindDuplicatesResult> getResults() {
        if (results == null) {
            results = new ArrayList<FindDuplicatesResult>();
        }
        return this.results;
    }

    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof FindDuplicatesByIdsResponse)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final FindDuplicatesByIdsResponse that = ((FindDuplicatesByIdsResponse) object);
        {
            List<FindDuplicatesResult> lhsResults;
            lhsResults = (((this.results!= null)&&(!this.results.isEmpty()))?this.getResults():null);
            List<FindDuplicatesResult> rhsResults;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            List<FindDuplicatesResult> theResults;
