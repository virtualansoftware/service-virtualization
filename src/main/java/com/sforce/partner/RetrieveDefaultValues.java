...
@XmlRootElement(name = "retrieveDefaultValues")
public class RetrieveDefaultValues
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof RetrieveDefaultValues)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final RetrieveDefaultValues that = ((RetrieveDefaultValues) object);
        {
