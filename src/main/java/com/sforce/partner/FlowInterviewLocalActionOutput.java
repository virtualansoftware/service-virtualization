...
/**
 * <p>Java class for FlowInterviewLocalActionOutput complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="FlowInterviewLocalActionOutput"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "FlowInterviewLocalActionOutput", propOrder = {
    "dataType",
    "isCollection",
    "name",
    "objectType"
})
public class FlowInterviewLocalActionOutput
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof FlowInterviewLocalActionOutput)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final FlowInterviewLocalActionOutput that = ((FlowInterviewLocalActionOutput) object);
        {
            String lhsDataType;
