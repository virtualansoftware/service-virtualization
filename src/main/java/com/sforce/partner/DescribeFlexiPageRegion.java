    ...
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof DescribeFlexiPageRegion)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final DescribeFlexiPageRegion that = ((DescribeFlexiPageRegion) object);
        {
            List<DescribeComponentInstance> lhsComponents;
            lhsComponents = (((this.components!= null)&&(!this.components.isEmpty()))?this.getComponents():null);
            List<DescribeComponentInstance> rhsComponents;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            List<DescribeComponentInstance> theComponents;
