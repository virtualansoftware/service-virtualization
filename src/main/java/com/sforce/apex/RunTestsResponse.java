 ...
 *       &lt;sequence&gt;
 *         &lt;element name="result" type="{http://soap.sforce.com/2006/08/apex}RunTestsResult"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "runTestsResponse")
public class RunTestsResponse
    implements Equals, HashCode, ToString
{

    @XmlElement(required = true)
    protected RunTestsResult result;
     ...
     *     
     */
    public RunTestsResult getResult() {
        return result;
    }
     ...
     *     
     */
    public void setResult(RunTestsResult value) {
        this.result = value;
    }

    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof RunTestsResponse)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final RunTestsResponse that = ((RunTestsResponse) object);
        {
            RunTestsResult lhsResult;
            lhsResult = this.getResult();
            RunTestsResult rhsResult;
