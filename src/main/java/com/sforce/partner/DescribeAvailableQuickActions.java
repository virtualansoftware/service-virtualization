    ...
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof DescribeAvailableQuickActions)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final DescribeAvailableQuickActions that = ((DescribeAvailableQuickActions) object);
        {
            String lhsContextType;
            lhsContextType = this.getContextType();
            String rhsContextType;
