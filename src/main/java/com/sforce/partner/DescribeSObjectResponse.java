    ...
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof DescribeSObjectResponse)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final DescribeSObjectResponse that = ((DescribeSObjectResponse) object);
        {
            DescribeSObjectResult lhsResult;
            lhsResult = this.getResult();
            DescribeSObjectResult rhsResult;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            DescribeSObjectResult theResult;
