 ...
 *       &lt;sequence&gt;
 *         &lt;element name="result" type="{urn:sobject.partner.soap.sforce.com}sObject"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "retrieveDefaultValuesResponse")
public class RetrieveDefaultValuesResponse
    implements Equals, HashCode, ToString
{

    @XmlElement(required = true, nillable = true)
    protected SObject result;
     ...
     *     
     */
    public void setResult(SObject value) {
        this.result = value;
    }

    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof RetrieveDefaultValuesResponse)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final RetrieveDefaultValuesResponse that = ((RetrieveDefaultValuesResponse) object);
        {
            SObject lhsResult;
