...
@XmlRootElement(name = "describeMiniLayout")
public class DescribeMiniLayout
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof DescribeMiniLayout)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final DescribeMiniLayout that = ((DescribeMiniLayout) object);
        {
