...
@XmlRootElement(name = "describeLayoutByUiTypeResponse")
public class DescribeLayoutByUiTypeResponse
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof DescribeLayoutByUiTypeResponse)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final DescribeLayoutByUiTypeResponse that = ((DescribeLayoutByUiTypeResponse) object);
        {
            DescribeLayoutResult lhsResult;
            lhsResult = this.getResult();
            DescribeLayoutResult rhsResult;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            DescribeLayoutResult theResult;
