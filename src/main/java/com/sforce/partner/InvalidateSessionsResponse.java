    ...
    implements Equals, HashCode, ToString
{
    ...
    protected List<InvalidateSessionsResult> results;
     ...
     * 
     */
    public List<InvalidateSessionsResult> getResults() {
        if (results == null) {
            results = new ArrayList<InvalidateSessionsResult>();
        }
        return this.results;
    }

    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof InvalidateSessionsResponse)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final InvalidateSessionsResponse that = ((InvalidateSessionsResponse) object);
        {
            List<InvalidateSessionsResult> lhsResults;
            lhsResults = (((this.results!= null)&&(!this.results.isEmpty()))?this.getResults():null);
            List<InvalidateSessionsResult> rhsResults;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            List<InvalidateSessionsResult> theResults;
