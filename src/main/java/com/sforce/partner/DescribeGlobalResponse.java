    ...
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof DescribeGlobalResponse)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final DescribeGlobalResponse that = ((DescribeGlobalResponse) object);
        {
            DescribeGlobalResult lhsResult;
            lhsResult = this.getResult();
            DescribeGlobalResult rhsResult;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            DescribeGlobalResult theResult;
