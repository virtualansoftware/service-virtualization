    ...
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof DescribeApprovalLayoutResponse)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final DescribeApprovalLayoutResponse that = ((DescribeApprovalLayoutResponse) object);
        {
            DescribeApprovalLayoutResult lhsResult;
            lhsResult = this.getResult();
            DescribeApprovalLayoutResult rhsResult;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            DescribeApprovalLayoutResult theResult;
