    ...
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof GetUpdatedResponse)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final GetUpdatedResponse that = ((GetUpdatedResponse) object);
        {
            GetUpdatedResult lhsResult;
            lhsResult = this.getResult();
            GetUpdatedResult rhsResult;
