    ...
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof DescribeCompactLayoutsResponse)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final DescribeCompactLayoutsResponse that = ((DescribeCompactLayoutsResponse) object);
        {
            DescribeCompactLayoutsResult lhsResult;
            lhsResult = this.getResult();
            DescribeCompactLayoutsResult rhsResult;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            DescribeCompactLayoutsResult theResult;
