    ...
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof SetPasswordResponse)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final SetPasswordResponse that = ((SetPasswordResponse) object);
        {
            SetPasswordResult lhsResult;
            lhsResult = this.getResult();
            SetPasswordResult rhsResult;
