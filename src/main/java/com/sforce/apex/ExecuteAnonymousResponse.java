 ...
 *       &lt;sequence&gt;
 *         &lt;element name="result" type="{http://soap.sforce.com/2006/08/apex}ExecuteAnonymousResult"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "executeAnonymousResponse")
public class ExecuteAnonymousResponse
    implements Equals, HashCode, ToString
{

    @XmlElement(required = true)
    protected ExecuteAnonymousResult result;
     ...
     *     
     */
    public void setResult(ExecuteAnonymousResult value) {
        this.result = value;
    }

    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof ExecuteAnonymousResponse)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final ExecuteAnonymousResponse that = ((ExecuteAnonymousResponse) object);
        {
            ExecuteAnonymousResult lhsResult;
            lhsResult = this.getResult();
            ExecuteAnonymousResult rhsResult;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            ExecuteAnonymousResult theResult;
