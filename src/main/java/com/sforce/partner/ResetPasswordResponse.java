    ...
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof ResetPasswordResponse)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final ResetPasswordResponse that = ((ResetPasswordResponse) object);
        {
            ResetPasswordResult lhsResult;
            lhsResult = this.getResult();
            ResetPasswordResult rhsResult;
