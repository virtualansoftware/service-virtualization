...
/**
 * <p>Java class for FlowInterviewMetadataValue complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="FlowInterviewMetadataValue"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "FlowInterviewMetadataValue", propOrder = {
    "name",
    "values"
})
public class FlowInterviewMetadataValue
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof FlowInterviewMetadataValue)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final FlowInterviewMetadataValue that = ((FlowInterviewMetadataValue) object);
        {
            String lhsName;
