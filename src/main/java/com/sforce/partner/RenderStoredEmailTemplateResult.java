...
/**
 * <p>Java class for RenderStoredEmailTemplateResult complex type.
 * 
 ...
 *         &lt;element name="renderedEmail" type="{urn:partner.soap.sforce.com}SingleEmailMessage"/&gt;
...
@XmlType(name = "RenderStoredEmailTemplateResult", propOrder = {
    "errors",
    "renderedEmail",
    "success"
})
    ...
    implements Equals, HashCode, ToString
{
    ...
    protected SingleEmailMessage renderedEmail;
    ...
    /**
     * Gets the value of the renderedEmail property.
     * 
     * @return
     *     possible object is
     ...
     *     
     */
    public SingleEmailMessage getRenderedEmail() {
        return renderedEmail;
    }

    /**
     * Sets the value of the renderedEmail property.
     * 
     * @param value
     *     allowed object is
     *     {@link SingleEmailMessage }
     *     
     */
    public void setRenderedEmail(SingleEmailMessage value) {
        this.renderedEmail = value;
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof RenderStoredEmailTemplateResult)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final RenderStoredEmailTemplateResult that = ((RenderStoredEmailTemplateResult) object);
        {
        ...
        {
            SingleEmailMessage lhsRenderedEmail;
            lhsRenderedEmail = this.getRenderedEmail();
            SingleEmailMessage rhsRenderedEmail;
            rhsRenderedEmail = that.getRenderedEmail();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "renderedEmail", lhsRenderedEmail), LocatorUtils.property(thatLocator, "renderedEmail", rhsRenderedEmail), lhsRenderedEmail, rhsRenderedEmail)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            SingleEmailMessage theRenderedEmail;
            theRenderedEmail = this.getRenderedEmail();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "renderedEmail", theRenderedEmail), currentHashCode, theRenderedEmail);
        }
        {
            boolean theSuccess;
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        }
        {
            SingleEmailMessage theRenderedEmail;
            theRenderedEmail = this.getRenderedEmail();
            strategy.appendField(locator, this, "renderedEmail", buffer, theRenderedEmail);
        }
        {
            boolean theSuccess;
            theSuccess = (true?this.isSuccess():false);
