    ...
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof DescribeSObjectListViewsResponse)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final DescribeSObjectListViewsResponse that = ((DescribeSObjectListViewsResponse) object);
        {
            DescribeSoqlListViewResult lhsResult;
            lhsResult = this.getResult();
            DescribeSoqlListViewResult rhsResult;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            DescribeSoqlListViewResult theResult;
