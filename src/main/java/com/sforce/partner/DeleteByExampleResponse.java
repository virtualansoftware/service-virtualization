 ...
 *       &lt;sequence&gt;
 *         &lt;element name="result" type="{urn:partner.soap.sforce.com}DeleteByExampleResult" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "deleteByExampleResponse")
public class DeleteByExampleResponse
    implements Equals, HashCode, ToString
{

    @XmlElement(name = "result")
    protected List<DeleteByExampleResult> results;
     ...
     * {@link DeleteByExampleResult }
     * 
     * 
     */
    public List<DeleteByExampleResult> getResults() {
        if (results == null) {
            results = new ArrayList<DeleteByExampleResult>();
        }
        return this.results;
    }

    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof DeleteByExampleResponse)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final DeleteByExampleResponse that = ((DeleteByExampleResponse) object);
        {
            List<DeleteByExampleResult> lhsResults;
            lhsResults = (((this.results!= null)&&(!this.results.isEmpty()))?this.getResults():null);
            List<DeleteByExampleResult> rhsResults;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            List<DeleteByExampleResult> theResults;
