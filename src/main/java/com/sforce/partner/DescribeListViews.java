...
@XmlRootElement(name = "describeListViews")
public class DescribeListViews
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof DescribeListViews)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final DescribeListViews that = ((DescribeListViews) object);
        {
