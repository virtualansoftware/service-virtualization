...
@XmlRootElement(name = "emailMergeResponse")
public class EmailMergeResponse
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof EmailMergeResponse)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final EmailMergeResponse that = ((EmailMergeResponse) object);
        {
            List<String> lhsResults;
            lhsResults = (((this.results!= null)&&(!this.results.isEmpty()))?this.getResults():null);
            List<String> rhsResults;
