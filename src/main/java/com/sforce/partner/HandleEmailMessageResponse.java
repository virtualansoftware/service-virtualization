 ...
 *       &lt;sequence&gt;
 *         &lt;element name="result" type="{urn:partner.soap.sforce.com}SaveResult" maxOccurs="10" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "handleEmailMessageResponse")
public class HandleEmailMessageResponse
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof HandleEmailMessageResponse)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final HandleEmailMessageResponse that = ((HandleEmailMessageResponse) object);
        {
