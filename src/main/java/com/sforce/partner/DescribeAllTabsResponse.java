    ...
    implements Equals, HashCode, ToString
{
    ...
    protected List<DescribeTab> results;
     ...
     * 
     */
    public List<DescribeTab> getResults() {
        if (results == null) {
            results = new ArrayList<DescribeTab>();
        }
        return this.results;
    }

    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof DescribeAllTabsResponse)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final DescribeAllTabsResponse that = ((DescribeAllTabsResponse) object);
        {
            List<DescribeTab> lhsResults;
            lhsResults = (((this.results!= null)&&(!this.results.isEmpty()))?this.getResults():null);
            List<DescribeTab> rhsResults;
