 ...
 *       &lt;sequence&gt;
 *         &lt;element name="result" type="{http://soap.sforce.com/2006/08/apex}CompileClassResult" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "compileClassesResponse")
public class CompileClassesResponse
    implements Equals, HashCode, ToString
{

    @XmlElement(name = "result")
    protected List<CompileClassResult> results;
     ...
     * 
     */
    public List<CompileClassResult> getResults() {
        if (results == null) {
            results = new ArrayList<CompileClassResult>();
        }
        return this.results;
    }

    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof CompileClassesResponse)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final CompileClassesResponse that = ((CompileClassesResponse) object);
        {
            List<CompileClassResult> lhsResults;
            lhsResults = (((this.results!= null)&&(!this.results.isEmpty()))?this.getResults():null);
            List<CompileClassResult> rhsResults;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            List<CompileClassResult> theResults;
