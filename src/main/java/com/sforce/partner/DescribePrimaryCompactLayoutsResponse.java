    ...
    implements Equals, HashCode, ToString
{
    ...
    protected List<DescribeCompactLayout> results;
     ...
     * 
     */
    public List<DescribeCompactLayout> getResults() {
        if (results == null) {
            results = new ArrayList<DescribeCompactLayout>();
        }
        return this.results;
    }

    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof DescribePrimaryCompactLayoutsResponse)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final DescribePrimaryCompactLayoutsResponse that = ((DescribePrimaryCompactLayoutsResponse) object);
        {
            List<DescribeCompactLayout> lhsResults;
            lhsResults = (((this.results!= null)&&(!this.results.isEmpty()))?this.getResults():null);
            List<DescribeCompactLayout> rhsResults;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            List<DescribeCompactLayout> theResults;
