    ...
    implements Equals, HashCode, ToString
{
    ...
    protected List<EmptyRecycleBinResult> results;
     ...
     * 
     */
    public List<EmptyRecycleBinResult> getResults() {
        if (results == null) {
            results = new ArrayList<EmptyRecycleBinResult>();
        }
        return this.results;
    }

    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof EmptyRecycleBinResponse)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final EmptyRecycleBinResponse that = ((EmptyRecycleBinResponse) object);
        {
            List<EmptyRecycleBinResult> lhsResults;
            lhsResults = (((this.results!= null)&&(!this.results.isEmpty()))?this.getResults():null);
            List<EmptyRecycleBinResult> rhsResults;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            List<EmptyRecycleBinResult> theResults;
