 ...
 *         &lt;element name="id" type="{urn:partner.soap.sforce.com}ID" minOccurs="0"/&gt;
    ...
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof EmailFileAttachment)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final EmailFileAttachment that = ((EmailFileAttachment) object);
        {
            byte[] lhsBody;
        ...
        {
            Boolean lhsInline;
            lhsInline = this.isInline();
            Boolean rhsInline;
            rhsInline = that.isInline();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "inline", lhsInline), LocatorUtils.property(thatLocator, "inline", rhsInline), lhsInline, rhsInline)) {
                return false;
            }
        }
        return true;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            Boolean theInline;
            theInline = this.isInline();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "inline", theInline), currentHashCode, theInline);
        }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        }
        {
            Boolean theInline;
            theInline = this.isInline();
            strategy.appendField(locator, this, "inline", buffer, theInline);
        }
        return buffer;
    }
