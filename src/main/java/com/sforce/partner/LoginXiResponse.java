...
@XmlRootElement(name = "loginXiResponse")
public class LoginXiResponse
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof LoginXiResponse)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final LoginXiResponse that = ((LoginXiResponse) object);
        {
            LoginResult lhsResult;
            lhsResult = this.getResult();
            LoginResult rhsResult;
