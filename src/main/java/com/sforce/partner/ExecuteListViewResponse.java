    ...
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof ExecuteListViewResponse)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final ExecuteListViewResponse that = ((ExecuteListViewResponse) object);
        {
            ExecuteListViewResult lhsResult;
            lhsResult = this.getResult();
            ExecuteListViewResult rhsResult;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            ExecuteListViewResult theResult;
