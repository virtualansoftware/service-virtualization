...
@XmlRootElement(name = "describeLookupLayouts")
public class DescribeLookupLayouts
    implements Equals, HashCode, ToString
{

    @XmlElement(name = "sObjectType")
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof DescribeLookupLayouts)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final DescribeLookupLayouts that = ((DescribeLookupLayouts) object);
        {
