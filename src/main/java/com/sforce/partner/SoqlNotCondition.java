    ...
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof SoqlNotCondition)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final SoqlNotCondition that = ((SoqlNotCondition) object);
        {
            SoqlWhereCondition lhsCondition;
            lhsCondition = this.getCondition();
            SoqlWhereCondition rhsCondition;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            SoqlWhereCondition theCondition;
