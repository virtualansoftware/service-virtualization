 ...
 *       &lt;sequence&gt;
 *         &lt;element name="result" type="{urn:partner.soap.sforce.com}DescribeWorkitemActionResult" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
    ...
    implements Equals, HashCode, ToString
{
    ...
    protected List<DescribeWorkitemActionResult> results;
     ...
     * 
     */
    public List<DescribeWorkitemActionResult> getResults() {
        if (results == null) {
            results = new ArrayList<DescribeWorkitemActionResult>();
        }
        return this.results;
    }

    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof DescribeWorkitemActionsResponse)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final DescribeWorkitemActionsResponse that = ((DescribeWorkitemActionsResponse) object);
        {
            List<DescribeWorkitemActionResult> lhsResults;
            lhsResults = (((this.results!= null)&&(!this.results.isEmpty()))?this.getResults():null);
            List<DescribeWorkitemActionResult> rhsResults;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            List<DescribeWorkitemActionResult> theResults;
