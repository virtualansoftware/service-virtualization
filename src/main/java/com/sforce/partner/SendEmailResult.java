    ...
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof SendEmailResult)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final SendEmailResult that = ((SendEmailResult) object);
        {
            List<SendEmailError> lhsErrors;
            lhsErrors = (((this.errors!= null)&&(!this.errors.isEmpty()))?this.getErrors():null);
            List<SendEmailError> rhsErrors;
