...
/**
 * <p>Java class for CommonEventResult complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="CommonEventResult"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "CommonEventResult", propOrder = {
    "success"
})
    ...
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof CommonEventResult)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final CommonEventResult that = ((CommonEventResult) object);
        {
            boolean lhsSuccess;
