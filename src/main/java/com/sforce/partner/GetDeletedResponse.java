    ...
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof GetDeletedResponse)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final GetDeletedResponse that = ((GetDeletedResponse) object);
        {
            GetDeletedResult lhsResult;
            lhsResult = this.getResult();
            GetDeletedResult rhsResult;
