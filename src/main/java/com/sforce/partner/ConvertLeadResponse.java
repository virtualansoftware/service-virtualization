    ...
    implements Equals, HashCode, ToString
{
    ...
    protected List<LeadConvertResult> results;
     ...
     * 
     */
    public List<LeadConvertResult> getResults() {
        if (results == null) {
            results = new ArrayList<LeadConvertResult>();
        }
        return this.results;
    }

    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof ConvertLeadResponse)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final ConvertLeadResponse that = ((ConvertLeadResponse) object);
        {
            List<LeadConvertResult> lhsResults;
            lhsResults = (((this.results!= null)&&(!this.results.isEmpty()))?this.getResults():null);
            List<LeadConvertResult> rhsResults;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            List<LeadConvertResult> theResults;
