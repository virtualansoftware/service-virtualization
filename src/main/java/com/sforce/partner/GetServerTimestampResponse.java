    ...
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof GetServerTimestampResponse)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final GetServerTimestampResponse that = ((GetServerTimestampResponse) object);
        {
            GetServerTimestampResult lhsResult;
            lhsResult = this.getResult();
            GetServerTimestampResult rhsResult;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            GetServerTimestampResult theResult;
