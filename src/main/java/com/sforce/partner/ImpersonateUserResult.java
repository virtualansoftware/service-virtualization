...
/**
 * <p>Java class for ImpersonateUserResult complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="ImpersonateUserResult"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "ImpersonateUserResult", propOrder = {
    "errors",
    "sessionId",
    "success",
    "userId"
    ...
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof ImpersonateUserResult)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final ImpersonateUserResult that = ((ImpersonateUserResult) object);
        {
