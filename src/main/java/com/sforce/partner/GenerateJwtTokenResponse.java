...
@XmlRootElement(name = "generateJwtTokenResponse")
    ...
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof GenerateJwtTokenResponse)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final GenerateJwtTokenResponse that = ((GenerateJwtTokenResponse) object);
        {
            String lhsResult;
