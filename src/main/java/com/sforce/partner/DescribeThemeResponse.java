    ...
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof DescribeThemeResponse)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final DescribeThemeResponse that = ((DescribeThemeResponse) object);
        {
            DescribeThemeResult lhsResult;
            lhsResult = this.getResult();
            DescribeThemeResult rhsResult;
