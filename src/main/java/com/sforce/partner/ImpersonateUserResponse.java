 ...
 *       &lt;sequence&gt;
 *         &lt;element name="result" type="{urn:partner.soap.sforce.com}ImpersonateUserResult" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
    ...
    implements Equals, HashCode, ToString
{
    ...
    protected List<ImpersonateUserResult> results;
     ...
     * {@link ImpersonateUserResult }
     * 
     * 
     */
    public List<ImpersonateUserResult> getResults() {
        if (results == null) {
            results = new ArrayList<ImpersonateUserResult>();
        }
        return this.results;
    }

    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof ImpersonateUserResponse)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final ImpersonateUserResponse that = ((ImpersonateUserResponse) object);
        {
            List<ImpersonateUserResult> lhsResults;
            lhsResults = (((this.results!= null)&&(!this.results.isEmpty()))?this.getResults():null);
            List<ImpersonateUserResult> rhsResults;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            List<ImpersonateUserResult> theResults;
