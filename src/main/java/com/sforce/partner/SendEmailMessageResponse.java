    ...
    implements Equals, HashCode, ToString
{
    ...
    protected List<SendEmailResult> results;
     ...
     * 
     */
    public List<SendEmailResult> getResults() {
        if (results == null) {
            results = new ArrayList<SendEmailResult>();
        }
        return this.results;
    }

    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof SendEmailMessageResponse)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final SendEmailMessageResponse that = ((SendEmailMessageResponse) object);
        {
            List<SendEmailResult> lhsResults;
            lhsResults = (((this.results!= null)&&(!this.results.isEmpty()))?this.getResults():null);
            List<SendEmailResult> rhsResults;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            List<SendEmailResult> theResults;
