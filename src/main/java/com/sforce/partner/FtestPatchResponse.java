...
@XmlRootElement(name = "ftestPatchResponse")
public class FtestPatchResponse
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof FtestPatchResponse)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final FtestPatchResponse that = ((FtestPatchResponse) object);
        {
