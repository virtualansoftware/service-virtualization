    ...
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof NameObjectValuePair)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final NameObjectValuePair that = ((NameObjectValuePair) object);
        {
            Boolean lhsIsVisible;
            lhsIsVisible = this.isIsVisible();
            Boolean rhsIsVisible;
            rhsIsVisible = that.isIsVisible();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "isVisible", lhsIsVisible), LocatorUtils.property(thatLocator, "isVisible", rhsIsVisible), lhsIsVisible, rhsIsVisible)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            Boolean theIsVisible;
            theIsVisible = this.isIsVisible();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "isVisible", theIsVisible), currentHashCode, theIsVisible);
        }
        {
            String theName;
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            Boolean theIsVisible;
            theIsVisible = this.isIsVisible();
            strategy.appendField(locator, this, "isVisible", buffer, theIsVisible);
        }
        {
            String theName;
            theName = this.getName();
