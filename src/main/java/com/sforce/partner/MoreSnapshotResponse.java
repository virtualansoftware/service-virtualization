...
@XmlRootElement(name = "moreSnapshotResponse")
public class MoreSnapshotResponse
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof MoreSnapshotResponse)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final MoreSnapshotResponse that = ((MoreSnapshotResponse) object);
        {
