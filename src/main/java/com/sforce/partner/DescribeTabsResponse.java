    ...
    implements Equals, HashCode, ToString
{
    ...
    protected List<DescribeTabSetResult> results;
     ...
     * 
     */
    public List<DescribeTabSetResult> getResults() {
        if (results == null) {
            results = new ArrayList<DescribeTabSetResult>();
        }
        return this.results;
    }

    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof DescribeTabsResponse)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final DescribeTabsResponse that = ((DescribeTabsResponse) object);
        {
            List<DescribeTabSetResult> lhsResults;
            lhsResults = (((this.results!= null)&&(!this.results.isEmpty()))?this.getResults():null);
            List<DescribeTabSetResult> rhsResults;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            List<DescribeTabSetResult> theResults;
