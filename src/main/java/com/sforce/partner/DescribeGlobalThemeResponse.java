    ...
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof DescribeGlobalThemeResponse)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final DescribeGlobalThemeResponse that = ((DescribeGlobalThemeResponse) object);
        {
            DescribeGlobalTheme2 lhsResult;
            lhsResult = this.getResult();
            DescribeGlobalTheme2 rhsResult;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            DescribeGlobalTheme2 theResult;
