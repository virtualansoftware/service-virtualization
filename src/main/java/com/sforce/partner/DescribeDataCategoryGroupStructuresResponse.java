    ...
    implements Equals, HashCode, ToString
{
    ...
    protected List<DescribeDataCategoryGroupStructureResult> results;
     ...
     * 
     */
    public List<DescribeDataCategoryGroupStructureResult> getResults() {
        if (results == null) {
            results = new ArrayList<DescribeDataCategoryGroupStructureResult>();
        }
        return this.results;
    }

    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof DescribeDataCategoryGroupStructuresResponse)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final DescribeDataCategoryGroupStructuresResponse that = ((DescribeDataCategoryGroupStructuresResponse) object);
        {
            List<DescribeDataCategoryGroupStructureResult> lhsResults;
            lhsResults = (((this.results!= null)&&(!this.results.isEmpty()))?this.getResults():null);
            List<DescribeDataCategoryGroupStructureResult> rhsResults;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            List<DescribeDataCategoryGroupStructureResult> theResults;
