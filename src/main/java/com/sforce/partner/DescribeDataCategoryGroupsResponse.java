    ...
    implements Equals, HashCode, ToString
{
    ...
    protected List<DescribeDataCategoryGroupResult> results;
     ...
     * 
     */
    public List<DescribeDataCategoryGroupResult> getResults() {
        if (results == null) {
            results = new ArrayList<DescribeDataCategoryGroupResult>();
        }
        return this.results;
    }

    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof DescribeDataCategoryGroupsResponse)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final DescribeDataCategoryGroupsResponse that = ((DescribeDataCategoryGroupsResponse) object);
        {
            List<DescribeDataCategoryGroupResult> lhsResults;
            lhsResults = (((this.results!= null)&&(!this.results.isEmpty()))?this.getResults():null);
            List<DescribeDataCategoryGroupResult> rhsResults;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            List<DescribeDataCategoryGroupResult> theResults;
