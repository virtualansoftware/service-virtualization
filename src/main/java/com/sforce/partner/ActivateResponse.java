 ...
 *       &lt;sequence&gt;
 *         &lt;element name="result" type="{urn:partner.soap.sforce.com}ActivateResult" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
    ...
    implements Equals, HashCode, ToString
{
    ...
    protected List<ActivateResult> results;
     ...
     * 
     */
    public List<ActivateResult> getResults() {
        if (results == null) {
            results = new ArrayList<ActivateResult>();
        }
        return this.results;
    }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            List<ActivateResult> theResults;
