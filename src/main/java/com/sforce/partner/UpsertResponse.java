    ...
    implements Equals, HashCode, ToString
{
    ...
    protected List<UpsertResult> results;
     ...
     * 
     */
    public List<UpsertResult> getResults() {
        if (results == null) {
            results = new ArrayList<UpsertResult>();
        }
        return this.results;
    }

    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof UpsertResponse)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final UpsertResponse that = ((UpsertResponse) object);
        {
            List<UpsertResult> lhsResults;
            lhsResults = (((this.results!= null)&&(!this.results.isEmpty()))?this.getResults():null);
            List<UpsertResult> rhsResults;
