    ...
    implements Equals, HashCode, ToString
{
    ...
    protected List<DescribeSObjectResult> results;
     ...
     * 
     */
    public List<DescribeSObjectResult> getResults() {
        if (results == null) {
            results = new ArrayList<DescribeSObjectResult>();
        }
        return this.results;
    }

    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof DescribeSObjectsResponse)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final DescribeSObjectsResponse that = ((DescribeSObjectsResponse) object);
        {
            List<DescribeSObjectResult> lhsResults;
            lhsResults = (((this.results!= null)&&(!this.results.isEmpty()))?this.getResults():null);
            List<DescribeSObjectResult> rhsResults;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            List<DescribeSObjectResult> theResults;
