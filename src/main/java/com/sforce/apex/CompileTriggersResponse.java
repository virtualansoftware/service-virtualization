 ...
 *       &lt;sequence&gt;
 *         &lt;element name="result" type="{http://soap.sforce.com/2006/08/apex}CompileTriggerResult" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "compileTriggersResponse")
public class CompileTriggersResponse
    implements Equals, HashCode, ToString
{

    @XmlElement(name = "result")
    protected List<CompileTriggerResult> results;
     ...
     * 
     */
    public List<CompileTriggerResult> getResults() {
        if (results == null) {
            results = new ArrayList<CompileTriggerResult>();
        }
        return this.results;
    }

    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof CompileTriggersResponse)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final CompileTriggersResponse that = ((CompileTriggersResponse) object);
        {
            List<CompileTriggerResult> lhsResults;
            lhsResults = (((this.results!= null)&&(!this.results.isEmpty()))?this.getResults():null);
            List<CompileTriggerResult> rhsResults;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            List<CompileTriggerResult> theResults;
