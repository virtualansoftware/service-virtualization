    ...
    implements Equals, HashCode, ToString
{
    ...
    protected List<DescribeSearchLayoutResult> results;
     ...
     * 
     */
    public List<DescribeSearchLayoutResult> getResults() {
        if (results == null) {
            results = new ArrayList<DescribeSearchLayoutResult>();
        }
        return this.results;
    }

    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof DescribeSearchLayoutsResponse)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final DescribeSearchLayoutsResponse that = ((DescribeSearchLayoutsResponse) object);
        {
            List<DescribeSearchLayoutResult> lhsResults;
            lhsResults = (((this.results!= null)&&(!this.results.isEmpty()))?this.getResults():null);
            List<DescribeSearchLayoutResult> rhsResults;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            List<DescribeSearchLayoutResult> theResults;
