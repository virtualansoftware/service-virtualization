 ...
 *         &lt;element name="uiType" type="{urn:partner.soap.sforce.com}UiType" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "describeLayoutByUiType")
public class DescribeLayoutByUiType
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof DescribeLayoutByUiType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final DescribeLayoutByUiType that = ((DescribeLayoutByUiType) object);
        {
        ...
        {
            String lhsLayoutName;
            lhsLayoutName = this.getLayoutName();
            String rhsLayoutName;
            rhsLayoutName = that.getLayoutName();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "layoutName", lhsLayoutName), LocatorUtils.property(thatLocator, "layoutName", rhsLayoutName), lhsLayoutName, rhsLayoutName)) {
                return false;
            }
        }
        {
        ...
        {
            UiType lhsUiType;
            lhsUiType = this.getUiType();
            UiType rhsUiType;
            rhsUiType = that.getUiType();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "uiType", lhsUiType), LocatorUtils.property(thatLocator, "uiType", rhsUiType), lhsUiType, rhsUiType)) {
                return false;
            }
        }
        return true;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            String theLayoutName;
            theLayoutName = this.getLayoutName();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "layoutName", theLayoutName), currentHashCode, theLayoutName);
        }
        {
        ...
        {
            UiType theUiType;
            theUiType = this.getUiType();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "uiType", theUiType), currentHashCode, theUiType);
        }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        }
        {
            String theLayoutName;
            theLayoutName = this.getLayoutName();
            strategy.appendField(locator, this, "layoutName", buffer, theLayoutName);
        }
        {
            List<String> theRecordTypeIds;
            theRecordTypeIds = (((this.recordTypeIds!= null)&&(!this.recordTypeIds.isEmpty()))?this.getRecordTypeIds():null);
        ...
        }
        {
            UiType theUiType;
            theUiType = this.getUiType();
            strategy.appendField(locator, this, "uiType", buffer, theUiType);
        }
        return buffer;
    }
