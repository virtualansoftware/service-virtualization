...
@XmlRootElement(name = "startFlowInterviewResponse")
public class StartFlowInterviewResponse
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof StartFlowInterviewResponse)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final StartFlowInterviewResponse that = ((StartFlowInterviewResponse) object);
        {
