...
/**
 * <p>Java class for FlowInterviewScreenFieldOutput complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="FlowInterviewScreenFieldOutput"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "FlowInterviewScreenFieldOutput", propOrder = {
    "dataType",
    "isCollection",
    "name",
    "objectType"
})
public class FlowInterviewScreenFieldOutput
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof FlowInterviewScreenFieldOutput)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final FlowInterviewScreenFieldOutput that = ((FlowInterviewScreenFieldOutput) object);
        {
            String lhsDataType;
