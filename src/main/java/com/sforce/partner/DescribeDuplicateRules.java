...
@XmlRootElement(name = "describeDuplicateRules")
public class DescribeDuplicateRules
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof DescribeDuplicateRules)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final DescribeDuplicateRules that = ((DescribeDuplicateRules) object);
        {
