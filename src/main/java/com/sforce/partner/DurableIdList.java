...
/**
 * <p>Java class for DurableIdList complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="DurableIdList"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "DurableIdList", propOrder = {
    "ids"
})
public class DurableIdList
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof DurableIdList)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final DurableIdList that = ((DurableIdList) object);
        {
            List<String> lhsIds;
