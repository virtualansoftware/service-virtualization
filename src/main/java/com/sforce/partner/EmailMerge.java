 ...
 *       &lt;sequence&gt;
 *         &lt;element name="template" type="{urn:partner.soap.sforce.com}ID"/&gt;
 *         &lt;element name="id" type="{urn:partner.soap.sforce.com}ID" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "emailMerge")
    ...
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof EmailMerge)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final EmailMerge that = ((EmailMerge) object);
        {
            String lhsTemplate;
