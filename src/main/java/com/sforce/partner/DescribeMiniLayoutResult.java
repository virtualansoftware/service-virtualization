...
/**
 * <p>Java class for DescribeMiniLayoutResult complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="DescribeMiniLayoutResult"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "DescribeMiniLayoutResult", propOrder = {
    "layouts",
    "recordTypeMappings",
    "recordTypeSelectorRequired"
})
public class DescribeMiniLayoutResult
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof DescribeMiniLayoutResult)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final DescribeMiniLayoutResult that = ((DescribeMiniLayoutResult) object);
        {
