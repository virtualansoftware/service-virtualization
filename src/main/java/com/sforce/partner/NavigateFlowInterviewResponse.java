...
@XmlRootElement(name = "navigateFlowInterviewResponse")
public class NavigateFlowInterviewResponse
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof NavigateFlowInterviewResponse)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final NavigateFlowInterviewResponse that = ((NavigateFlowInterviewResponse) object);
        {
