    ...
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof DescribeSoftphoneLayoutResponse)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final DescribeSoftphoneLayoutResponse that = ((DescribeSoftphoneLayoutResponse) object);
        {
            DescribeSoftphoneLayoutResult lhsResult;
            lhsResult = this.getResult();
            DescribeSoftphoneLayoutResult rhsResult;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            DescribeSoftphoneLayoutResult theResult;
