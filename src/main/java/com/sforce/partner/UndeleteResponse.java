    ...
    implements Equals, HashCode, ToString
{
    ...
    protected List<UndeleteResult> results;
     ...
     * 
     */
    public List<UndeleteResult> getResults() {
        if (results == null) {
            results = new ArrayList<UndeleteResult>();
        }
        return this.results;
    }

    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof UndeleteResponse)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final UndeleteResponse that = ((UndeleteResponse) object);
        {
            List<UndeleteResult> lhsResults;
            lhsResults = (((this.results!= null)&&(!this.results.isEmpty()))?this.getResults():null);
            List<UndeleteResult> rhsResults;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            List<UndeleteResult> theResults;
